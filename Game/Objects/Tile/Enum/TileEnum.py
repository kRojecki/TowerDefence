class TileEnum:
    EMPTY_TILE = 'Game.Objects.Tile.EmptyTile.EmptyTile'
    SMALL_TURRET_TILE = 'Game.Objects.Tile.Turrets.TriangleTurret.TriangleTurret'
    ROCKET_TURRET_TILE = 'Game.Objects.Tile.Turrets.RocketTurretTile.RocketTurretTile'
